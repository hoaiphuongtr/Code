...
import { addPost, cancelEditingPost, saveEditingPost } from 'Page/Blog/blog.reducer'
...
export default function CreatePost() {
  ...
  const handleSubmitPost = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (editingPost) {
      dispatch(saveEditingPost(formData))
    } else {
  ...
  const handleCanCelDeletingPost = () => {
    dispatch(cancelEditingPost())
  }
  return (
    <form onSubmit={handleSubmitPost} onReset={handleCanCelDeletingPost}>
      <div className='mb-6'>
